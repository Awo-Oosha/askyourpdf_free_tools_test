...
const { mutate, isLoading } = useMutation(
  ...
  async () => {
    ...
    await GenerateCall('INSTAGRAM_CAPTION', generateInput, generateParameters);
  ...
  return (
    <Generator
      header="AI Instagram Caption Generator"
      subheader="Instagram Caption Generator"
      desc="Fill in the field (s) below to generate your Rap"
      mainBarDesc= "Generate Instagram Caption"
