...
elevate your academic work.</Trans></div>
</ToolComp>
<ToolComp href="split">
  <Image src={SplitIcon} alt=""/>
  <div className="thead"><Trans>PDF Splitter</Trans></div>
  <div className="tdesc"><Trans>Let artificial intelligence do the work as it divides your
PDF documents into separate files, saving you time
and streamlining your document management tasks.</Trans></div>
</ToolComp>
<ToolComp href="merge">
  <Image src={MergeIcon} alt=""/>
  <div className="thead"><Trans>PDF Merger</Trans></div>
  <div className="tdesc"><Trans>With smart, automated merging, your PDFs are unified
seamlessly into a single, cohesive document while 
maintaining quality and formatting.</Trans></div>
</ToolComp>
<ToolComp href="ocr">
  <Image src={ScanIcon} alt=""/>
  <div className="thead"><Trans>OCR PDF Reader</Trans></div>
  <div className="tdesc"><Trans>Transform scanned or image-based PDFs into editable
