...
const DocumentSelectModal = dynamic(
  () => import("@/components/Modals/DocumentSelectModal"),
  {
    ssr: false,
  }
);
...
const searchModeRepresentation = {
  chat: "Chat",
  docs: "Docs",
...
export default function KnowledgeBaseSidebar({
  ...
  return (
    <MainSidebarStyles $isOpen={isOpen}>
      <Actions>
        ...
        {!searchMode ? (
          <ModeSwitcher>
            <Tabs
              defaultActiveKey={"1"}
              items={[{ label: t`Knowledge Base`, key: "1" }]}
              tabBarExtraContent={{
                right: (
                  <TabActions>
                    {/* <button
                    ...
                    <button
                      ...
                      onClick={() => {
                        if (router.pathname.includes("/documents")) {
                          setSearchMode("docs");
                        } else if (router.pathname.includes("/conversations")) {
                          setSearchMode("chat");
                        } else {
                          setSearchMode("knowledgeBase");
                        }
                      }}
                    >
          ...
          <SearchBar>
            ...
            >
              <SearchSelector>
                <Space>
                  <p>{searchModeRepresentation[searchMode]}</p>
                  <CaretDown />
                </Space>
              </SearchSelector>
            </Dropdown>
        ...
        {!searchMode &&
          ...
          userSubscriptionInfo?.subscription_status === "past_due" && (
            <AppAlert
              ...
              message={t`Your subscription could not be renewed because billing failed. Please check your payment method`}
              action={
                <AlertButton
                  mobileOnly={true}
      ...
      {documentSelectModalOpen && (
        <DocumentSelectModal
          open={documentSelectModalOpen}
          setOpen={setDocumentSelectModalOpen}
