...
function ModalContent({
  ...
  return (
    <ModalContentStyles>
      <h1>
        <Trans>Clear Conversation History</Trans>
      </h1>
      <p>
        <Trans>Are you sure you want to clear your conversation history?</Trans>
      </p>
      <div>
        <button
          onClick={() => {
...
export default function ConversationHistoryDeleteModal({
  open,
  setOpen,
  handleDelete,
  isDeleting,
