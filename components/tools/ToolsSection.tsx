        ...
        <ToolsList>
            <ToolsListInner>
                <ToolComp href="source-tool">
                    ...
                    <Tdesc>
                        <Trans>
                            Enhance your research with our Source-Tool, which automatically cites and creates references
                            for your academic text.
                        </Trans>
                    </Tdesc>
                </ToolComp>
                <ToolComp href="literature-review-writer">
                    ...
                    <Tdesc><Trans>Harness the power of our AI-driven Literature Review Assistant. Simplify your research
                        process, produce structured overviews, and craft in-depth literature reviews
                        to elevate your academic work.</Trans></Tdesc>
                </ToolComp>
                <ToolComp href="split">
                    <Image src={SplitIcon} alt=""/>
                    <Thead> <Trans>PDF Splitter</Trans></Thead>
                    <Tdesc> <Trans>Efficiently split, separate, and manage your PDF files using our superior free online
                        PDF splitter.</Trans></Tdesc>

                </ToolComp>
                <ToolComp href="merge">
                    <Image src={MergeIcon} alt=""/>
                    <Thead><Trans>PDF Merger</Trans></Thead>
                    <Tdesc><Trans>With our smart, automated merging, your PDFs are unified
                ...
                <ToolComp href="ocr">
                    ...
                    <Tdesc><Trans>Transform scanned or image-based PDFs into editable
                        and searchable text with our AI powered OCR PDF Reader.</Trans></Tdesc>
                </ToolComp>
            </ToolsListInner>
        </ToolsList>
    );
