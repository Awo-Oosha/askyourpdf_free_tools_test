...
const ToolsMerge = () => {
    ...
    const desc = <Trans>With our smart, automated merging, your PDFs are unified seamlessly into a single, cohesive document while maintaining quality and formatting.</Trans>;
