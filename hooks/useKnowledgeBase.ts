...
import { sendKnowledgeBaseMessage } from "@/services/knowledgeBase";
import { useConversations } from "@/providers/ConversationsProvider";

export default function useKnowledgeBase(chatLoader: any, stopConversationRef: any, idType: any, id: any) {
        ...
        (newMessage: any) => {
            ...
            timeoutPromise(
                ...
                .then((response) => {
                    ...
                    reader?.read().then(processText).catch((err: any) => {
                ...
                .catch((err: any) => {
                    ...
                    if (messages.length > 1 && newMessage.question.length > 0) {
                        const lastMessageState = [...messages];
                        setMessages(lastMessageState);
                    }
